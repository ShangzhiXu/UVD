...
void UseAfterFreeChecker ::reportNeverFree(const SVFGNode* src)
{
...
void UseAfterFreeChecker ::reportPartialLeak(const SVFGNode* src)
{
 ...
 */
void UseAfterFreeChecker ::testsValidation(const ProgSlice* slice)
{
...
void UseAfterFreeChecker ::validateSuccessTests(const SVFGNode* source, const SVFFunction* fun)
{
...
void UseAfterFreeChecker::validateExpectedFailureTests(const SVFGNode* source, const SVFFunction* fun)
{
