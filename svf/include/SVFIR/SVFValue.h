...
{
public:
    //const Instruction* inst; // LLVM instruction
...
public:
   ...
   // SVFInstruction(Instruction* inst, const std::string& i, const SVFType* ty, const SVFBasicBlock* b, bool tm, bool isRet, SVFValKind k = SVFInst);
