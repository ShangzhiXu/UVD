 ...
 */
class UseAfterFreeChecker: public llvm::InstVisitor<UseAfterFreeChecker>
{
...
public:
    /// Constructor
    UseAfterFreeChecker(SVFModule* mod): pag(SVFIR::getPAG()), svfModule(mod), curBB(nullptr),curVal(nullptr)
    {
    }
    /// Destructor
