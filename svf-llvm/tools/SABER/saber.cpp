...
int main(int argc, char ** argv)
{
    ...
    SVFModule* svfModule = LLVMModuleSet::getLLVMModuleSet()->buildSVFModule(moduleNameVec);//create the module, init, create id for each val and each instruction and so on
    SVFIRBuilder builder(svfModule);
    SVFIR* pag = builder.build();// create pag
